...
def main(args):
    try:
        ...
        Agg = args.agg
        Format = args.format
        keyList = ast.literal_eval(args.keyList)
    except:
        pass
...
#pp.pprint(getKeyList('DEVICE', 'a145c370-d741-11e8-b2de-4be867fcc47c'))
#pp.pprint(getLatestValue('DEVICE', 'a145c370-d741-11e8-b2de-4be867fcc47c'))
#print(exportLog('DEVICE', 'a145c370-d741-11e8-b2de-4be867fcc47c',['Var1','Var2','Var3','Var4','Var5'],1541467715000, 1541770115000, 1200000, True, 500, AVG, CSV))
